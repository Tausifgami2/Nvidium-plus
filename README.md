...
[![License](https://img.shields.io/badge/License-LGPL--3.0-orange)](https://github.com/Tausifgami2/Nvidium-plus/blob/main/LICENSE.txt)
...
```bash
git clone https://github.com/Tausifgami2/nvidium-plus
cd nvidium-plus
./gradlew build
```
...
- **BalancingLight** ([Tausifgami2](https://github.com/Tausifgami2)) — Nvidium++ development, entity GPU rendering system, 1.21.11 port
...
LGPL-3.0 — see [LICENSE.txt](https://github.com/Tausifgami2/Nvidium-plus/blob/main/LICENSE.txt)
